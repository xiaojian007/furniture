	...
	<div class="list-panel" v-loading="loading">
		...
		<div class="list-result">
			<div class="list-buttons">
				<el-button type="primary" size="small" :loading="querying" @click="$refs.edit.add(params.skuId)"
					>添加
				</el-button>
						...
						>
							<template slot-scope="scope">
								<template v-if="field.prop === 'operation'">
									<el-button type="text" @click="$refs.edit.add(params.skuId, scope.row.skuId)">
										修改
									</el-button>
									<el-button type="text" @click="deleteSku(scope.row)">
										删除
									</el-button>
								</template>
								<template v-else>
		...
		<EditSku ref="edit" @success="query"></EditSku>
	</div>
</template>

<script>
	import listMixin from "@mixins/list.mixin";
	import { getSkuList, deleteSkuType } from "@api/commodity/sku";
	import EditSku from "./components/DialogEditSku";
